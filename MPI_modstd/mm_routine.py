...
rootname = "data-test/K"
its = 1000                              # Numero de iteracoes
...
vars = np.linspace(0,0.5,100) # Valor de K
Nwaves = 10
for var_i in range(0,len(vars)):
    ...
    for i in range(0,Nfull):
        ...
        L0 = i*Npar
        print()
        runstring = "mpirun -np " + str(Npar)  + " ./a.out " + str(scase) + " " +  str(L0) + " " + str(its) + " " + str(Nwaves) + " " + str(vars[var_i]) + " " + sfile + " " + folder
        print(runstring)
        os.system(runstring)
    ...
    if Nstarts%Npar != 0:
        L0 = Nfull*Npar
        runstring = "mpirun -np " + str(Nleft) + " ./a.out " + str(scase) + " " +  str(L0) + " " + str(its) + " " + str(Nwaves) + " " + str(vars[var_i]) + " " + sfile + " " + folder
        #print(runstring)
        os.system(runstring)

    #os.system("python3 mm.py " + folder)
    #os.system("python3 plot_each.py " + folder)
