...
rootname = "data-test_mat/trajs_A2_theta"
its = 1000                              # Numero de iteracoes
Npar = 8                               # Numero de runs paralelas

scase = 1 # 0 => grid definido (configurar no program), 1 => pontos aleatorios, 2 => le um arquivo especificado
...
vars = [0.1,0.2,0.5] # Amplitude
vars2 = [0,np.pi/2,np.pi/4] # fase
