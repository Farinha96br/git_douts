...
# compilação
t_all = time.time()
programscript = "lyap_integrador.cpp"
...
vars = [0.1,0.2,0.3]
lenvar = len(vars)
startfiles = ["sep_200_3_3.dat"] # arquivo de cond. iniciais
rootname = "data-Lyap_A2" # Nome principal da rodada de experimentos, sem hifen no final
############################
...
#SBATCH --mail-user=farinha96br@gmail.com \n \n")
    ...
    if mesoBool == False:
        ...
        #os.system("python3 plot_mapa2.py " + out_folder + " " + varstring)
